...
# Description:  ERGM Estimation of HS8703 in 2006. ERGM includes gwesp and MRT covariate. The MRT term is the product of the fixed effects divided by the max of the products.
...
setwd("ergm_analysis\\HS 50 countries\\hs8703")

total_countries = 50
year.used = 2006
version_name = "2006_ergm_hs8703_top50"


dropcountries <- c("NULL","ARB", "ATF", "COD", "IOT", "SCG") # ("NULL","ARB", "ATF", "COD", "IOT", "SCG") are missing in gravity data.

# Paths for data
trade_data_path = "ergm_analysis\\HS 50 countries\\data\\hs8703_baci_data_2006_top50_traders.csv"
mr_path = "ergm_analysis\\HS 50 countries\\hs8703\\ppml_hs8703_top50_standard_fe_estimates.csv"
...
ergm.output <-  ergm( agg.network ~ edges + mutual + edgecov(dist.network, attrname = "distw") +
