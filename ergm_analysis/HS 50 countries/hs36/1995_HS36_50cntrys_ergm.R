...
# Description:  ERGM Estimation of HS36 in 1995. ERGM includes gwesp and MRT covariate. The MRT term is the product of the fixed effects divided by the max of the products.
