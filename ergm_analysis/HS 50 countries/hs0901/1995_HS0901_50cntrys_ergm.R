...
# Description:  ERGM Estimation of HS0901 in 1995. ERGM includes gwesp and MRT covariate. The MRT term is the product of the fixed effects divided by the max of the products.
...
setwd("ergm_analysis\\HS 50 countries\\hs0901")

total_countries = 50
year.used = 1995
version_name = "1995_ergm_hs0901_top50"


dropcountries <- c("NULL","ARB", "ATF", "COD", "IOT", "SCG") # ("NULL","ARB", "ATF", "COD", "IOT", "SCG") are missing in gravity data.

# Paths for data
trade_data_path = "ergm_analysis\\HS 50 countries\\data\\hs0901_baci_data_1995_top50_traders.csv"
mr_path = "ergm_analysis\\HS 50 countries\\hs0901\\ppml_hs0901_top50_standard_fe_estimates.csv"
