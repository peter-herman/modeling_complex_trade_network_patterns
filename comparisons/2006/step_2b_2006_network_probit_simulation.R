#--------------------------------------------------------------------------------------------------------------------
# Description: This script simulates and computes GOF tests for a full network probit model of trade. It uses data produced 
#           by "comparisons\1995\step1_1995_partial_gravity_analysis_for_comparisons.do". This
#           simulation uses predictions from the model with constrained est values for all but degrees and MRT proxies 
#           to include degree terms
#--------------------------------------------------------------------------------------------------------------------
...
version_name = "2006_network_probit_simulation"
sample_size = 100
year_num = 2006

save_path = "D:\\work\\Peter_Herman\\projects\\trade_network_revisions_2020\\submission_files\\comparisons\\2006\\2006_results"
data_location = "D:\\work\\Peter_Herman\\projects\\trade_network_revisions_2020\\submission_files\\comparisons\\2006\\2006_results\\2006_probit_predicted_probabilities_subset_network_stats.csv"
...
prob_data[which(is.na(prob_data$phat_all_ntwk)),'phat_all_ntwk'] = 0
...
for(i in 1:sample_size){
  ...
  sim_list[i] = var_name
  set.seed(i)
  hold =  1*(prob_data['phat_all_ntwk'] > runif(nobs))
