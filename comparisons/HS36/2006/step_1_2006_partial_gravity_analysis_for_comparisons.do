...
* of the top 50 copuntries and trade in HS chapter 36 for use in the model comparrisons.
* log close
clear all
set matsize 8000
set maxvar 30000
cd "comparisons\HS36\2006\2006_results"

log using "2006_partial_gravity_log.txt ", replace
set more off

local use_year 2006

import delimited "comparisons\HS36\partial_data_set_hs36_top50_with_ntw_vars.csv", varnames(1) clear
...
export delimited exporter importer year traded phat_standard phat_bilat_ntwk phat_all_ntwk using "2006_probit_predicted_probabilities_subset_network_stats", replace
