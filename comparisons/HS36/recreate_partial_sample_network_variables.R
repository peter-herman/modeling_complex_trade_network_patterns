...
data_path = "ergm_analysis\\HS 50 countries\\data\\ppml_hs36_panel_top50.dta"
save_path = "comparisons\\HS36\\\\partial_data_set_hs36_top50_with_ntw_vars.csv"
...
grav_part = grav_data[,c("iso3_o", "iso3_d", "year","gdp_d","gdpcap_d", "gdp_o", "gdpcap_o", "gatt_o", "gatt_d")]
