...
* of the top 50 copuntries and trade in HS chapter 45 for use in the model comparrisons.
* log close
clear all
set matsize 8000
set maxvar 30000
...
log using "1995_partial_gravity_log_hs45.log ", replace
set more off

local use_year 1995

import delimited "comparisons\HS45\partial_data_set_hs45_top50_with_ntw_vars.csv", varnames(1) clear
...
export delimited exporter importer year traded phat_standard phat_bilat_ntwk phat_all_ntwk using "1995_probit_predicted_probabilities_subset_network_stats_hs45", replace
