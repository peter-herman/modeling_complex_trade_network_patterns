...
* of the top 50 copuntries and trade in HS chapter 8703 for use in the model comparrisons.
* log close
clear all
set matsize 8000
set maxvar 30000
cd "comparisons\HS8703"

log using "2006_partial_gravity_log_hs8703.txt ", replace
set more off

local use_year 2006

import delimited "comparisons\HS8703\partial_data_set_hs8703_top50_with_ntw_vars.csv", varnames(1) clear
...
export delimited exporter importer year traded phat_standard phat_bilat_ntwk phat_all_ntwk using "2006_probit_predicted_probabilities_subset_network_stats_hs8703", replace
