* PPML Gravity analysis using cross section of HS36 in 1995
...
log using "hs36_1995_two_stage_ppml_log.log", replace
set more off
...
parmest, saving(ppml_hdfe_standard_hs36_1995, replace) stars(0.1 0.05 0.01)
...
parmest, saving(ppml_hdfe_network_hs36_1995, replace) stars(0.1 0.05 0.01)
...
parmest, saving(ppml_hdfe_trans_only_hs36_1995, replace) stars(0.1 0.05 0.01)
...
parmest, saving(ppml_hdfe_cycl_only_hs36_1995, replace) stars(0.1 0.05 0.01)
estimates store network_ppml_cyclical



* Store Estimates
esttab standard_ppml network_ppml network_ppml_transitive network_ppml_cyclical using ppml_hdfe_multi-specs_output_hs36_1995.txt, se aic pr2 scalars(ll) star(* 0.1 ** 0.05 *** 0.01) replace 
...
export delimited using standard_fe_estimates_hs36_1995.csv, replace
restore
...
save second_stage_data_hs36_1995.dta, replace
restore 
** 
* Importer FEs
**
...
esttab  importer_fe_lnremote importer_fe_lnr_network importer_fe_network exporter_fe_lnremote exporter_fe_lnr_network exporter_fe_network using second_stage_hs36_1995.txt, se ar2 star(* 0.1 ** 0.05 *** 0.01) replace
