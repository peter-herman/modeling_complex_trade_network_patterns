...
set matsize 8000
set maxvar 30000
cd "D:\work\Peter_Herman\projects\trade_network_research\files_used_in_submission\gravity_analysis\comparrison_specifications\2006"

log using "2006_partial_garvity_log.txt", replace
set more off
...
export delimited exporter importer year traded phat_1 phat_2 phat_3 phat_4 using "2006_probit_predicted_probabilities_subset_network_stats", replace
...
// Did not converge
*ppml trade_value lndist contig comlang_ethno colony rta   recip_dummy transitive_count cyclical_count importer_imp_degree importer_exp_degree exporter_exp_degree exporter_imp_degree exp_fe*  imp_fe*  year_fe*, cluster(clusterid) noconstant 
